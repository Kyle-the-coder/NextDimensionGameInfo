...
const DisplayOne = (props) => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://api.rawg.io/api/games/${id}/movies?key=4ed9711a54af43bc8bbd53f3bbf3b161`)
            .then(res => {
        ...
        axios.get(`https://api.rawg.io/api/games/${id}/screenshots?key=4ed9711a54af43bc8bbd53f3bbf3b161`)
            .then(res => {
        ...
        axios.get(`https://api.rawg.io/api/games/${id}/achievements?key=4ed9711a54af43bc8bbd53f3bbf3b161`)
            .then(res => {
        ...
        axios.get(`https://api.rawg.io/api/games/${id}/stores?key=4ed9711a54af43bc8bbd53f3bbf3b161`)
            .then(res => {
        ...
        axios.get(`https://api.rawg.io/api/games/${id}/additions?key=4ed9711a54af43bc8bbd53f3bbf3b161`)
            .then(res => {
